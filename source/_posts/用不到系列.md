...
<div class="myBody">
  <div class="mandatory">
    ...
    <a id="man-a" target="_blank">开始聊天</a>
  </div>
  <div class="axiosImg">
    <div class="sjtxImg">
      头像
      ...
      <label><input type="radio" name="sjtx" value="c3">动漫男头</label><br>
    </div>
    <div class="sjbzImg">
      背景
      <label><input type="radio" name="sjbz" value="meizi">美女</label>
    ...
    <button style="margin-top: 20px;" onclick="getSuiJiTouXiang()">获取头像</button>
    <button style="margin-top: 20px; margin-left: 20px;" onclick="getsjbz()">获取背景</button>
  </div>
  <div class="qrcode">
    <input type="text" id="qrcode" placeholder="输入转换的信息">
    <input type="number" id="qrcodeSize" placeholder="输入二维码的尺寸默认300">
  ...
  <div class="yan">
    <p id="yantext" style="height: 16px;display: block;"></p>
    <button onclick="getyan()">获取鸡汤</button>
  </div>
